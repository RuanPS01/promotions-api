package br.inatel.promotions.api.product.controller;

import br.inatel.promotions.api.core.ApiException;
import br.inatel.promotions.api.product.ProductRequest;
import br.inatel.promotions.api.product.service.ProductService;
import br.inatel.promotions.persistence.product.Product;
...
//http://localhost:8080/dm111promo/products
@RestController
