package br.inatel.promotions.api.supermaketlist.controller;



import br.inatel.promotions.api.core.ApiException;
import br.inatel.promotions.api.supermaketlist.SuperMarketListRequest;
import br.inatel.promotions.api.supermaketlist.service.SuperMarketListService;
...
//http://localhost:8080/promotions/users/{userId}/supermarketlist
@RestController
